 ...
 * @author Kuroi-Tenshi
 */
public class ChangePosition extends javax.swing.JDialog {
    private InterfaceGraphique fenetre;
    private Personne info;
    /**
     * Creates new form AddXP
     */
    public ChangePosition(java.awt.Frame parent, boolean modal, Personne gens) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ResultSet res = Connect.requete("select * from utilisateurs where role='employe'");
            DefaultComboBoxModel box = (DefaultComboBoxModel) jComboBoxEmploye.getModel();
            while(res.next()){                
                box.addElement(res.getString("nom"));
            }
        } catch (SQLException ex) {
            Logger.getLogger(ChangePosition.class.getName()).log(Level.SEVERE, null, ex);
        }
        } else {
            try {
            ResultSet res = Connect.requete("select * from utilisateurs");
            DefaultComboBoxModel box = (DefaultComboBoxModel) jComboBoxEmploye.getModel();
            while(res.next()){                
                box.addElement(res.getString("nom"));
            }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Position actuel :");
        ...
        jLabel4.setText("Nouvelle position :");
        ...
        jComboBoxNew.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "non cadre", "cadre", "dirigeant" }));
    ...
    private void jButtonValideActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonValideActionPerformed
        Connect.requete2("Update utilisateurs set categorie='"+jComboBoxNew.getSelectedItem()+"' where nom='"+jComboBoxEmploye.getSelectedItem()+"'");
    ...
    private void jComboBoxEmployeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxEmployeActionPerformed
        try {
            ...
            if(res.next()){                
                jLabelRole.setText(res.getString("categorie"));
            }
        } catch (SQLException ex) {
            Logger.getLogger(ChangePosition.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangePosition.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChangePosition dialog = new ChangePosition(new javax.swing.JFrame(), true, null);
