 ...
 * @author Kuroi-Tenshi
 */
public class AddLangue extends javax.swing.JDialog {
    private MenuLangue fenetre;
    private Personne info;
    /**
     * Creates new form AddXP
     */
    public AddLangue(java.awt.Dialog parent, boolean modal, Personne gens) {
        super(parent, modal);
        initComponents();
    ...
    private void jButtonValideActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonValideActionPerformed
        ...
        Connect.requete2("Insert into cv_langue (id_utilisateur, libelle_langue, niveau) values("+id+",'"+titre+"','"+descri+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddLangue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddLangue dialog = new AddLangue(new javax.swing.JDialog(), true, null);
