 ...
 * @author Kuroi-Tenshi
 */
public class MesInfo extends javax.swing.JDialog {
    private MenuInfo fenetre;
    private Personne info;
    /**
     * Creates new form AddXP
     */
    public MesInfo(java.awt.Dialog parent, boolean modal, Personne gens) {
        super(parent, modal);
        initComponents();
        ...
        Connect.getConnect();
        try {
            ResultSet res = Connect.requete("Select * from cv_informatique where id_utilisateur=" + info.getId());
            DefaultComboBoxModel box = (DefaultComboBoxModel) jComboBoxPerso.getModel();
            while (res.next()) {
                box.addElement(res.getString("libelle_informatique"));
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mes Informatique");
    ...
    private void jButtonValideActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonValideActionPerformed
        ...
        Connect.requete2("update cv_informatique set libelle_informatique='"+titre+"', description='"+descri+"' where id_informatique="+Integer.parseInt(jLabelId.getText()));
    ...
    private void jComboBoxPersoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxPersoActionPerformed
        try {
            ResultSet res = Connect.requete("Select * from cv_informatique where libelle_informatique='" + jComboBoxPerso.getSelectedItem() + "'");
            if (res.next()) {
                jTextFieldTitre.setText(res.getString("libelle_informatique"));
                jTextFieldDescri.setText(res.getString("description"));
                jLabelId.setText(res.getString("id_informatique"));
            }
        } catch (SQLException ex) {
    ...
    private void jButtonSupprimerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupprimerActionPerformed
        Connect.requete2("delete from cv_informatique where id_informatique="+Integer.parseInt(jLabelId.getText()));
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MesInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MesInfo dialog = new MesInfo(new javax.swing.JDialog(), true, null);
