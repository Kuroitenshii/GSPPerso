 ...
 * @author Kuroi-Tenshi
 */
public class AddHobbie extends javax.swing.JDialog {
    private MenuHobbie fenetre;
    private Personne info;
    /**
     * Creates new form AddXP
     */
    public AddHobbie(java.awt.Dialog parent, boolean modal, Personne gens) {
        super(parent, modal);
        initComponents();
    ...
    private void jButtonValideActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonValideActionPerformed
        ...
        Connect.requete2("Insert into cv_centre_interet (id_utilisateur, libelle_centre_interet, description) values("+id+",'"+titre+"','"+descri+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddHobbie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddHobbie dialog = new AddHobbie(new javax.swing.JDialog(), true, null);
